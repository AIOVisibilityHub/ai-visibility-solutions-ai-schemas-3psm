...
BIZ = _client.get('name') or manifest.get('businessName', 'AI Visibility Solutions')
WEBSITE = _client.get('canonicalUrl') or manifest.get('canonicalUrl', '') or manifest.get('websiteUrl', 'aiovisibility.com')
